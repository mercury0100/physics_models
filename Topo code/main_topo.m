...
N = 202;        % Total number of waveguides (even)
n = 10;         % Number of waveguides between topological defects (even)
disorder = 0.6;   % Disorder in the gap between waveguides
...
% Set-up Hamiltonian
[v, H, disarray, seed] = two_topo_defect(N, n, w, gap, wavelength, disorder/2, diag_disorder);
...
hold on; plot(y(N/2:N/2+1), E(N/2:N/2+1), 'r.', 'MarkerSize', 12);
